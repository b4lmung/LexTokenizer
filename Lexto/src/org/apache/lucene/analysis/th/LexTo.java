...
//	} // Constructor
	...
	/**************************** addDict ******************************/
	/*******************************************************************/
	public void addDict(Set<String> lexitron) throws IOException {
		for(String s: lexitron){
			s = s.trim();
			if(s.length() > 0)
				dict.add(s);
		}
	...
	public static void main(String[] args) throws IOException {
		...
		//read dictionary
		try(BufferedReader br = new BufferedReader(new InputStreamReader(LexTo.class.getResourceAsStream("com/job/ic/nlp/word/segment/lexitron.txt")))){
			String tmp;
		...
		LexTo tokenizer = new LexTo(dict);
		Vector typeList;
